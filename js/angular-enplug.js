...
// Enplug SDK API
    var Apps = function () {
        ...
        return {
            ...
            getDefaultAssets: function (successCallback, errorCallback) {
                var methodCall = { name: 'getDefaultAssets', successCallback: successCallback, errorCallback: errorCallback };
                transport.callMethod(methodCall);
            },

            createDefaultAsset: function (name, value, successCallback, errorCallback) {
                var methodCall = {
                    name: 'createDefaultAsset',
                    params: [name, value],
                    successCallback: successCallback,
                    errorCallback: errorCallback
                };
